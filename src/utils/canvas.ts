...
export class Canvas {
  ...
  constructor(options: CanvasOptions = {}) {
    ...
    this.canvas.addEventListener("touchmove", this.mouseMove.bind(this), {passive: false});
    this.canvas.addEventListener("mousedown", this.mouseDown.bind(this), {passive: false, capture: true});
    this.canvas.addEventListener("touchstart", this.mouseDown.bind(this), {passive: false, capture: true});
    this.canvas.addEventListener("mouseup", this.mouseUp.bind(this), {passive: false});
    this.canvas.addEventListener("touchend", this.mouseUp.bind(this), {passive: false});
    this.canvas.addEventListener("mouseleave", this.mouseLeave.bind(this), {passive: false});
    this.canvas.addEventListener("touchcancel", this.mouseLeave.bind(this), {passive: false});
  }
